...
: ${AMENT_CURRENT_PREFIX:="/workspaces/ros2project/install/task1"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/task1/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/task1/environment/path.sh"
