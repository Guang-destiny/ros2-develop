...
: ${AMENT_CURRENT_PREFIX:="/workspaces/ros2project/install/motor_simulator"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/motor_simulator/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/motor_simulator/environment/path.sh"
